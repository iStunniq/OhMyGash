...
public class ManageServicesFragment extends Fragment {
    ...
    DatabaseReference prodRef = FirebaseDatabase.getInstance().getReference("Service");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_manage_services, container, false);
        FBAuth = FirebaseAuth.getInstance();
        FBUser = FBAuth.getCurrentUser();

        recyclerView = root.findViewById(R.id.ServiceFragmentRecycler);
