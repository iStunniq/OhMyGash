...
public class ManageGasolineFragment extends Fragment {

    DatabaseReference prodRef = FirebaseDatabase.getInstance().getReference("Gasoline");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_manage_gasoline, container, false);
        FBAuth = FirebaseAuth.getInstance();
        FBUser = FBAuth.getCurrentUser();

        recyclerView = root.findViewById(R.id.GasolineFragmentRecycler);
